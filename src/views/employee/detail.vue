          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="聘用形式" prop="formOfEmployment">
                <el-select v-model="userInfo.formOfEmployment" placeholder="请选择聘用形式" size="mini" class="inputW">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        formOfEmployment: [{ required: true, message: '请选择员工聘用形式', trigger: 'blur' }],
  ...
  created() {
    ...
    // if (this.$route.params.id) { getEmployeeDetail() }
